...
/**
  ...
  Date
*/
+ (NSDate * _Nullable)fromYear:(NSInteger)year month:(NSInteger)month day:(NSInteger)day;
/**
  ...
  Date
*/
+ (NSDate * _Nonnull)fromUnix:(double)unix;
/**
  ...
  Date
*/
+ (NSDate * _Nonnull)parseWithDateStr:(NSString * _Nonnull)dateStr format:(NSString * _Nonnull)format;
/**
  ...
  Double
*/
+ (double)unixWithDate:(NSDate * _Nonnull)date;
@end
